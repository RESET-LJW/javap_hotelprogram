...
public class Room {
	...
	public int guestState(String name, String phoneNumber) {
		if (this.guest != null && this.roomState.equals("예약") && this.guest.getName().equals(name)
				&& this.guest.getName().equals(name)) {
			return 1;
		} else if (this.guest != null && this.roomState.equals("투숙") && this.guest.getName().equals(name)
				&& this.guest.getName().equals(name)) {
			return 2;
		} else {
			return 0;
